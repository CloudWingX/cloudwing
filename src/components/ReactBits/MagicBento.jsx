...
const DEFAULT_GLOW_COLOR = '200, 200, 205'; // 中性灰白，贴合本站黑白配色
const MOBILE_BREAKPOINT = 768;

const DEFAULT_ITEMS = [
  { color: '#161619', title: 'CloudWing_X', description: 'AI 图像创作者 · 独立个人', label: 'PROFILE' },
  { color: '#161619', title: '作品库', description: '编号完整的生成作品与配方记录', label: 'WORKS' },
  { color: '#161619', title: '影集', description: '游戏截图与日常收藏 · MC × 40', label: 'GALLERY' },
  { color: '#161619', title: '联系', description: '邮件 / GitHub / Bilibili', label: 'CONTACT' },
  { color: '#161619', title: '本站', description: 'Astro · 玻璃扁平 · 记录可追溯', label: 'THIS SITE' }
];
...
const MagicBento = ({
  ...
  const items = data && data.length ? data : DEFAULT_ITEMS;
